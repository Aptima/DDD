    ...
    public partial class ViewProSim : ISimulator
    {
        ...
        private void ForceUpdateObjectAttribute(SimulationEvent e)
        {
            ...
            if (attributeName == "Location")
            {
                ...
                //if (DataValueFactory.CompareDataValues(origDestination, origLocation) || !origDestination.exists)
                //{
                acv.attributes.Add("DestinationLocation", val); //AD: For Cville always set dest = loc.
                //}
                try
                {
        ...
        private void HandshakeInitializeGUIDone(SimulationEvent e)
        {
            ...
            {
                SendViewProActiveRegionUpdate(reg.id, reg.isVisible, reg.displayColor, reg.poly);
            }
        }
