...
{
    class ColorWheel : DashboardVisualization
    {
        private Aptima.Visualization.ColorWheel colorWheel = new Aptima.Visualization.ColorWheel();

        public ColorWheel(ConfigDisplay configDisplay, ConfigDataModel configDataModel, Dictionary<string, XmlWriter> measureInstXmlMap)
        ...
        public override void InitVisualization(System.Windows.Controls.StackPanel configDisplayPanel)
        {
            ...
            colorWheel.center = new Point(200, 200);
        }
        ...
        public override void UpdateVisualization()
        {
            ...
            var visualizationsToBeRemoved = grid.Children.OfType<Aptima.Visualization.ColorWheel>();
            ...
            for (int i = 0; i < xLabels.Count; i++)
            {
                ...
                {
                    //colorWheel.innerValues = ??;
                    //colorWheel.outerValues = ??;
                }
            }

            colorWheel.generate();
            Grid.SetColumn(colorWheel, 0);
            Grid.SetRow(colorWheel, 0);
