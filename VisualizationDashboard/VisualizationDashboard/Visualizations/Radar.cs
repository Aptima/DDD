...
{
    class Radar : DashboardVisualization
    {
        private Aptima.Visualization.Radar radar = new Aptima.Visualization.Radar();

        public Radar(ConfigDisplay configDisplay, ConfigDataModel configDataModel, Dictionary<string, XmlWriter> measureInstXmlMap)
        ...
        public override void InitVisualization(System.Windows.Controls.StackPanel configDisplayPanel)
        {
            ...
            radar.center = new Point(200, 200);
        }
        ...
        public override void UpdateVisualization()
        {
            ...
            var visualizationsToBeRemoved = grid.Children.OfType<Aptima.Visualization.Radar>();
