...
namespace VisualizationDashboard 
{
    class DragAdorner : Adorner
    {
        ...
        public DragAdorner(UIElement owner, UIElement adornElement, bool useVisualBrush, double opacity, double scale)
            : base(owner)
        {
            ...
            if (useVisualBrush)
            {
                ...
                XCenter = adornElement.DesiredSize.Width / 4 * scale;
                YCenter = adornElement.DesiredSize.Height / 4 * scale;
