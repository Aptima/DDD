...
namespace Aptima.Asim.DDD.ScenarioParser
{
    ...
    public class Parser_4_0_2 : AbstractParser
    {
        ...
        private static string[][] stageMembers = new string[][]{
            ...
            new string[]{"Create_Event","Reveal_Event","Move_Event","Completion_Event",
                        ...
                        "Attack_Successful_Event","Attack_Request_Approval","SetRegionVisibility"},
            new string[]{"Rule"},
            new string[]{"Score"}
       };
        ...
        public Parser_4_0_2()//XmlReader reader)
        {
            //   this.reader = reader;
...
"Violet", "Yellow", "YellowGreen"
 ...
 ": ", e);
        ...
        {
            throw new Exception("Parser_4_0_2 shouldn't call pGetWeaponLaunch()");
            //return null;
        }
