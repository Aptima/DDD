...
namespace Aptima.Asim.DDD.ScenarioParser
{
    ...
    public class Parser_4_0 : AbstractParser
    {
        ...
        private static string[][] stageMembers = new string[][]{
            ...
            new string[]{"Create_Event","Reveal_Event","Move_Event","Completion_Event",
                         "Species_Completion_Event","StateChange_Event","Transfer_Event","Launch_Event",
                         "DefineEngram","ChangeEngram","RemoveEngram","FlushEvents","Reiterate","OpenChatRoom","CloseChatRoom"},
            new string[]{"Rule"},
            new string[]{"Score"}
       };
        ...
        public Parser_4_0()//XmlReader reader)
        {
            //   this.reader = reader;
...
"SlateBlue", "SlateGray", "Tan", "Teal", "Transparent", "Turquoise",
"Violet", "Yellow", "YellowGreen"
        ...
        { // Note: does not have any tags to bypass
            ...
            try
            {
                ...
                {
                    if ("" != parseOfString[i]) returnValue.Add(parseOfString[i]);
                }
                return returnValue;
            }
        ...
        public override pEmitterType pGetEmitter()
        {
           ...
           */
            ...
            return new pEmitterType(attribute, level);
        }
        ...
        public override pArmamentType pGetArmament()
        {
            string arm = "Unknowm armament";
            int count;
            try
            {
                reader.Read();
            ...
            {
                throw new ApplicationException("Error reading armament named " + arm + ": ", e);
            }
            return new pArmamentType(arm, count);
        }
        public override pDockedPlatformType pGetDockedPlatform()
        {
            pDockedPlatformType p;
            try
            {
                reader.Read();
                int count = pGetInt();
                ...
                p = new pDockedPlatformType(count);
            ...
            {
                throw new ApplicationException("Error reading Docked platform: ", e);
            }
            return p;
        }
        public override pAdoptType pGetAdoptType()
        {
            pAdoptType returnValue;
            string child = "Unknown unit";
            ...
            try
            {
                ...
                child = pGetString();
                returnValue = new pAdoptType(child);
                if ("Location" == reader.Name)
                {
                    returnValue.Location = pGetLocation();
                    if ("InitialState" == reader.Name)
                    {

                        returnValue.InitialState = pGetString();
                    }
                    if ("InitialParameters" == reader.Name)
                    {
                        returnValue.Add(pGetParameters());
                    }
                }
                reader.ReadEndElement();
                return returnValue;
            ...
            {
                throw new ApplicationException("Error in Adopt statement with  child = " + child, e);
            }
        }
 ...
 ": ", e);
        ...
        public override pPlayfieldType pGetPlayfield()
        {
            ...
            return new pPlayfieldType(mapFileName, iconLibrary, utmZone, verticalScale, horizontalScale,"","");
        }
        ...
        public override pDecisionMakerType pGetDecisionMaker()
        {
            ...
            {
                throw new ApplicationException("Error reading Decision maler with role " +
                    role + ": ", e);
            }

            return new pDecisionMakerType(role, identifier, color, briefing, team);
        }
        ...
        public override pCreateType pGetCreate()
        {
            ...
            try
            {
                ...
                {
                    c.Add(pGetSubplatform());
                }
                while ("Adopt_Platform" == reader.Name)
                {
                    c.Add(pGetAdoptType());
                }
                reader.ReadEndElement();
        ...
        // should not be used by older parsers
        public override pWeaponLaunchType pGetWeaponLaunch()
        {
            throw new Exception("Parser_4_0 shouldn't call pGetWeaponLaunch()");
            return null;
        }
        ...
        public override pChangeEngramType pGetChangeEngram()
        {
            ...
            try
            {
                ...
                engramValue = pGetString();
                reader.ReadEndElement();
                return new pChangeEngramType(name, time, engramValue);
            }
            catch (SystemException e)
            {
