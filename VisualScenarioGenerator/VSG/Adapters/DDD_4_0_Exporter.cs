...
{
    public class DDD_4_0_Exporter : ControllerToXmlAdapter<IXPathNavigable>
    {
        private DDD_4_0_ExporterSettings settings;
        private XPathExpression expression;

        public DDD_4_0_Exporter(DDD_4_0_ExporterSettings settings) : base((ControllerToXmlSettings)settings)
        {
            this.settings = settings;
        }

        public DDD_4_0_Exporter(Controller controller,
                                RootController rootController,
                                Boolean treeDataFormat) : base(controller, rootController, treeDataFormat)
        {
            this.settings = new DDD_4_0_ExporterSettings(controller, rootController, treeDataFormat);
        }
        ...
        private void createScenario(XPathNavigator navigator, XmlDocument document)
        {
            ...
            schema.Value = @"DDDSchema_4_0.xsd";
            ...
            if (navLocal != null)
            {
                switch (navLocal.GetAttribute("Type", navLocal.NamespaceURI))
                {
                    ...
                    case "CreateEvent":
                        ...
                        break;
                    case "Engram":
                        createDefineEngram(navLocal, document, parentElement, navGlobal);
                        break;
                    case "FlushEvent":
        ...
        private Boolean validate(IXPathNavigable iNav)
        {
            ...
            XmlReader schemaDatabase = settings.controller.GetXSD("DDDSchema_4_0.xsd");
    ...
    public class DDD_4_0_ExporterSettings : ControllerToXmlSettings
    {
        public DDD_4_0_ExporterSettings(Controller controller,
                                        RootController rootController,
                                        Boolean treeDataFormat) : base(controller, rootController, treeDataFormat)
        {
        }
