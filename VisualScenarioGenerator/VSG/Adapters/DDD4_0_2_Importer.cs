...
{
    class DDD4_0_2_Importer : ValidationHelper, IImportAdapter
    {
        ...
        public DDD4_0_2_Importer(IController validatingController) : base(validatingController)
        {
        ...
        private Boolean validate(String uri, out IXPathNavigable iNav)
        {
            ...
            XmlReader schemaDatabase = validatingController.GetXSD("DDDSchema_4_0_2.xsd");
