...
{
    public class DDD_4_1_Exporter : ControllerToXmlAdapter<IXPathNavigable>
    {
        private DDD_4_1_ExporterSettings settings;
        private XPathExpression expression;
        private List<string> createdObjectIds = new List<string>();

        public DDD_4_1_Exporter(DDD_4_1_ExporterSettings settings) : base((ControllerToXmlSettings)settings)
        {
            this.settings = settings;
            createdObjectIds = new List<string>();
        }

        public DDD_4_1_Exporter(Controller controller,
                                RootController rootController,
                                Boolean treeDataFormat) : base(controller, rootController, treeDataFormat)
        {
            this.settings = new DDD_4_1_ExporterSettings(controller, rootController, treeDataFormat);
            createdObjectIds = new List<string>();
        }
        ...
        private void createScenario(XPathNavigator navigator, XmlDocument document)
        {
            ...
            schema.Value = @"DDDSchema_4_1_1.xsd";
        ...
        private Boolean validate(IXPathNavigable iNav)
        {
            ...
            XmlReader dddSchema = settings.controller.GetXSD("DDDSchema_4_1_1.xsd");
    ...
    public class DDD_4_1_ExporterSettings : ControllerToXmlSettings
    {
        public DDD_4_1_ExporterSettings(Controller controller,
                                        RootController rootController,
                                        Boolean treeDataFormat) : base(controller, rootController, treeDataFormat)
        {
